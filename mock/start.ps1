...
if ($Mode -eq "local") {
    ...
    Write-Host "  GET  /api/security/score"
    Write-Host "  GET  /api/security/cascade-risks"
    Write-Host "  GET  /api/pillars/{1-4}/..."
    Write-Host "  GET  /api/alerts/active"
    Write-Host "  GET  /api/recommendations"
    Write-Host "  POST /api/recommendations/:id/acknowledge"
    Write-Host "  GET  /api/raw/{fuel-prices,grid-load}/latest"
